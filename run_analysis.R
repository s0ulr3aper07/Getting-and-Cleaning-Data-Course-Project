...
test_data <- read.table(".//Getting&CleaningData//UCI HAR Dataset//test//X_test.txt")

### Read in the Subject IDs for Test Data ###
sub_ID <- read.table(".//Getting&CleaningData//UCI HAR Dataset//test//subject_test.txt")

### Read in the Activity Labels for Test Data ###
labels <- read.table(".//Getting&CleaningData//UCI HAR Dataset//test//y_test.txt")
...
train_data <- read.table(".//Getting&CleaningData//UCI HAR Dataset//train//X_train.txt")

### Read in the Subject IDs for Train Data ###
sub_ID_2 <- read.table(".//Getting&CleaningData//UCI HAR Dataset//train//subject_train.txt")

### Read in the Activity Labels for Train Data ###
labels_2 <- read.table(".//Getting&CleaningData//UCI HAR Dataset//train//y_train.txt")
...
features <- read.table(".//Getting&CleaningData//UCI HAR Dataset//features.txt", stringsAsFactors = F)
...
act_names <- read.table(".//Getting&CleaningData//UCI HAR Dataset//activity_labels.txt")
